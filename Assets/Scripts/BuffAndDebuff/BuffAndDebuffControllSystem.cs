...
namespace Assets.Scripts.BuffsAndDebuffs
{
    public class BuffAndDebuffControllSystem
    {
        ...
        private Dictionary<Unit, (List<Effect<Unit>> attackEffects, List<Effect<Unit>> moveEffects)> _effectsDictionary =
            new Dictionary<Unit, (List<Effect<Unit>> attackEffects, List<Effect<Unit>> moveEffect)>();
        ...
        public void AddItem(Unit unit, Effect<Unit> effect)
        {
            ...
            {
                (List<Effect<Unit>> attackEffects, List<Effect<Unit>> moveEffect) newTupple =
                    (new List<Effect<Unit>>(), new List<Effect<Unit>>());
