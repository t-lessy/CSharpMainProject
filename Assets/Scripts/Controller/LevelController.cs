...
namespace Controller
{
    public class LevelController : IPlayerUnitChoosingListener
    {
        ...
        public void OnPlayersUnitChosen(UnitConfig unitConfig)
        {
            ...
            SpawnUnit(RuntimeModel.PlayerId, unitConfig, _unitCoordinator);
            TryStartSimulation();
        }

        private void OnBotUnitChosen(UnitConfig unitConfig)
        {
            SpawnUnit(RuntimeModel.BotPlayerId, unitConfig, _unitCoordinator);
            TryStartSimulation();
        }

        private void SpawnUnit(int forPlayer, UnitConfig config, UnitCoordinator unitCoordinator)
        {
